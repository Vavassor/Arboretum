...
const Float3 float3_red     = {{1.0f, 0.0f, 0.0f}};
const Float3 float3_green   = {{0.0f, 1.0f, 0.0f}};
const Float3 float3_blue    = {{0.0f, 0.0f, 1.0f}};
const Float3 float3_cyan    = {{0.0f, 1.0f, 1.0f}};
const Float3 float3_magenta = {{1.0f, 0.0f, 1.0f}};
const Float3 float3_yellow  = {{1.0f, 1.0f, 0.0f}};
const Float3 float3_black   = {{0.0f, 0.0f, 0.0f}};
const Float3 float3_white   = {{1.0f, 1.0f, 1.0f}};
